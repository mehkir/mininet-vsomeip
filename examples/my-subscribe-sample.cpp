...
class my_client_sample {
public:
    my_client_sample(bool _use_tcp) :
    ...
    bool init() {
        ...
        app_->register_state_handler(
                std::bind(&my_client_sample::on_state, this,
                        std::placeholders::_1));

        app_->register_message_handler(
                vsomeip::ANY_SERVICE, SAMPLE_INSTANCE_ID, vsomeip::ANY_METHOD,
                std::bind(&my_client_sample::on_message, this,
                        std::placeholders::_1));

        app_->register_availability_handler(SAMPLE_SERVICE_ID, SAMPLE_INSTANCE_ID,
                std::bind(&my_client_sample::on_availability,
                          this,
...
#ifndef VSOMEIP_ENABLE_SIGNAL_HANDLING
    my_client_sample *its_sample_ptr(nullptr);
...
int main(int argc, char **argv) {
    ...
    my_client_sample its_sample(use_tcp);
#ifndef VSOMEIP_ENABLE_SIGNAL_HANDLING
