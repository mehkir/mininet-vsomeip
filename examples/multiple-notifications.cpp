...
public:
    ...
    bool init() {
        ...
        app_->register_message_handler(
                DISTANCE_SERVICE_ID,
                DISTANCE_INSTANCE_ID,
                DISTANCE_SET_METHOD_ID,
                std::bind(&multiple_notifications::on_set, this,
                          std::placeholders::_1));

        // Offer distance service
    ...
    void offer() {
        ...
        app_->offer_service(DISTANCE_SERVICE_ID, DISTANCE_INSTANCE_ID);
        is_offered_ = true;
        notify_condition_.notify_one();
    }
    ...
    void stop_offer() {
        ...
        app_->stop_offer_service(DISTANCE_SERVICE_ID, DISTANCE_INSTANCE_ID);
        is_offered_ = false;
    }
        ...
        while (running_) {
            ...
            while (is_offered_ && running_) {
...

                {
                    ...
                    app_->notify(DISTANCE_SERVICE_ID, DISTANCE_INSTANCE_ID, DISTANCE_EVENT_ID, payload_);
                }
