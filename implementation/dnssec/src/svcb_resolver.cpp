...
namespace vsomeip_v3 {
    ...
    void svcb_resolve_callback(void *data, int status, int timeouts,
        ...
        while (svcbReplyPtr != nullptr) {
            ...
            service_data_and_cbs_->resume_process_offerservice_serviceentry_when_verified_callback_(service_data_and_cbs_->service, service_data_and_cbs_->instance, service_data_and_cbs_->major, service_data_and_cbs_->minor);
            //Assemble TLSA QNAME
