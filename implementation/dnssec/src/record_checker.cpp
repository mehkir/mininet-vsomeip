...
namespace vsomeip_v3 {
    ...
    void tlsa_resolve_callback(void *data, int status, int timeouts,
        ...
        while (tlsa_reply_ptr != nullptr) {
            ...
            remote_service_data_->request_cache_callback(remote_service_data_->remote_ip_address, remote_service_data_->service, remote_service_data_->instance, remote_service_data_->convert_DER_to_PEM_callback_(tlsa_reply_ptr->certificate_association_data));
