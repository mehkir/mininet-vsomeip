...
namespace vsomeip_v3 {
    ...
    typedef std::function<void(boost::asio::ip::address_v4, service_t, instance_t)> verify_publisher_signature_callback;
    ...
    typedef std::function<void(client_t, boost::asio::ip::address_v4, service_t, instance_t, major_version_t)> verify_client_info_and_signature_callback;
    struct client_data_and_cbs {
        ...
        verify_client_info_and_signature_callback verify_client_info_and_signature_callback_;
        convert_der_to_pem_callback convert_der_to_pem_callback_;
    };
