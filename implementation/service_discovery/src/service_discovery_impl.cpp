...
service_discovery_impl::process_offerservice_serviceentry(
    ...
    resume_when_verified(_service, _instance, _major, _minor);
}

void
service_discovery_impl::resume_when_verified(service_t _service, instance_t _instance, major_version_t _major, minor_version_t _minor) {
    ...
    if (_resume_process_offerservice_entry._service == _svcb_cache_entry._service
        ...
        VSOMEIP_DEBUG << ">>>>> service_discovery_impl::resume_when_verified: Found SVCB record for service=" << _service
        ...
        VSOMEIP_DEBUG << ">>>>> service_discovery_impl::resume_when_verified: Found no SVCB record for service=" << _service
        << ", instance=" << _instance << ", major=" << _major << ", minor=" << _minor << " (MEHMET MUELLER DEBUG) <<<<<";
    }
}
