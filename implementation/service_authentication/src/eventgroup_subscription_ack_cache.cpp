...
namespace vsomeip_v3 {
    ...
    void eventgroup_subscription_ack_cache::add_eventgroup_subscription_ack_cache_entry(service_t _service, instance_t _instance, eventgroup_t _eventgroup, major_version_t _major_version, ttl_t _ttl, uint8_t _counter, std::set<uint16_t> _clients, boost::asio::ip::address_v4 _sender_ip_address, boost::asio::ip::address_v4 _first_ip_address, uint16_t _port) {
        ...
        entry._port = _port;
        eventgroup_subscription_ack_cache_map[key_tuple] = entry;
    }
